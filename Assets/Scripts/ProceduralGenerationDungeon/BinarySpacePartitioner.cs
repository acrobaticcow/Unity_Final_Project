...
public class BinarySpacePartitioner
{
    ...
    public List<RoomNode> PrepareNodesCollection(
        int maxIterations,
        int roomWidthMin,
        int roomLengthMin
    )
    {
        Queue<RoomNode> graph = new();
        List<RoomNode> listToReturn = new();
    ...
    private void AddNewNodeToCollections(
        List<RoomNode> listToReturn,
        Queue<RoomNode> graph,
        RoomNode node
    )
