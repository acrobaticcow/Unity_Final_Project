    ...
    Vector3 CollideAndSlide(Vector3 vel, Vector3 center, int depth, Vector3 velInit)
    {
        ...
        )
        {
            ...
            float scale =
                ...
                ); // use to scale character velocity down along side the wall. it would stop the character when he facing directly to the wall
            ...
            return snapToSurface
                + CollideAndSlide(leftover, center + snapToSurface, depth + 1, velInit);
        }
